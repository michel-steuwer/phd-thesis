	...
	\begin{figure}[tbp]
		...
		\begin{tikzpicture}[vector/.style={minimum height=1cm, minimum width=0.5cm, draw},
          ...
          \begin{scope}[color=gray, font=\scriptsize]
            ...
            \node[rotate=90]      at (-0.1, 0.00)        {host};
          ...
          \end{scope}
          \node[vector]         at ( 2.00, 1.50) (d0f)  {$f$};
          
          \node[vector]         at ( 0.50, 0.00) (hs)   {$s$};
          \node[vector]         at ( 1.25, 0.00) (hf)   {$f$};
          ...
          \node[vector]         at ( 3.50, 1.50) (d0c)  {$c$};
          \node[vector]         at ( 3.50,-1.50) (d1c)  {$c$};
          
          \path (d0f.east) -- (d0c.west) node[pos=0.5]{$\Rightarrow$};;
          \path (d1f.east) -- (d1c.west) node[pos=0.5]{$\Rightarrow$};;
          
          \node[vector]         at ( 4.25, 0.00) (hc)   {$c$};
          
          \draw[->] (d0c) -- (hc);
          \draw[->] (d1c) -- (hc);
          
          \node[blockvector]    at ( 5.00, 1.50) (d0c')  {$c$};
          \begin{scope}[xshift=5.00cm, yshift=1.50cm]
            \path[draw] (-.25,0) -- (-.25,-.5) -- (.25,-.5) -- (.25,0);
            \path[draw, closingLine] (-.25,0) -- (.25,0);
          \end{scope}
          \node[blockvector]    at ( 5.00,-1.50) (d1c')  {$c$};
          \begin{scope}[xshift=5.00cm, yshift=-1.50cm]
            \path[draw] (-.25,0) -- (-.25,.5) -- (.25,.5) -- (.25,0);
            \path[draw, closingLine] (-.25,0) -- (.25,0);
          \end{scope}
          ...
          \node[vector]         at ( 5.50, 0.00) (hf)   {$f$};
          \node[blockvector]    at ( 5.75, 1.50) (d0f)  {$f$};
          \begin{scope}[xshift=5.75cm, yshift=1.50cm]
            \path[draw] (-.25,0) -- (-.25,-.5) -- (.25,-.5) -- (.25,0);
            \path[draw, closingLine] (-.25,0) -- (.25,0);
          \end{scope}
          \node[blockvector]    at ( 5.75,-1.50) (d1f)  {$f$};
          \begin{scope}[xshift=5.75cm, yshift=-1.50cm]
            \path[draw] (-.25,0) -- (-.25,.5) -- (.25,.5) -- (.25,0);
            \path[draw, closingLine] (-.25,0) -- (.25,0);
          \end{scope}
          ...
          \node[blockvector]    at ( 7.25, 1.50) (d0f') {$f$};
          \begin{scope}[xshift=7.25cm, yshift=1.50cm]
            \path[draw] (-.25,0) -- (-.25,-.5) -- (.25,-.5) -- (.25,0);
            \path[draw, closingLine] (-.25,0) -- (.25,0);
          \end{scope}
          \node[blockvector]    at ( 7.25,-1.50) (d1f') {$f$};
          \begin{scope}[xshift=7.25cm, yshift=-1.50cm]
            \path[draw] (-.25,0) -- (-.25,.5) -- (.25,.5) -- (.25,0);
            \path[draw, closingLine] (-.25,0) -- (.25,0);
          \end{scope}
