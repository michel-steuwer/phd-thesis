...
\begin{document}
  \begin{tikzpicture}[every node/.style={font=\LARGE, line width=.75mm}]
    ...
    \node[draw, minimum height=.75cm, minimum width=1.5cm] at (-2.75,-2) (dev0) {};

    \node[draw, minimum height=.75cm, minimum width=1.5cm] at (+2.75,-2) (dev1) {};

    \draw[->, >=open triangle 45, line width=.75mm] (host0.south) -- (dev0.north);
    \draw[->, >=open triangle 45, line width=.75mm] (host1.south) -- (dev1.north);
