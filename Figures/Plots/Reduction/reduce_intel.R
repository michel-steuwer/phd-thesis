...
text(1,topbw+1, "Hardware Bandwidth Limit", col="black", adj=c(0, 0), cex=0.6)

text(6.25,0.5, "Failed", col="black", adj=c(0, 0), cex=0.6)
text(7.75,0.5, "Failed", col="black", adj=c(0, 0), cex=0.6)
text(9.25,0.5, "Failed", col="black", adj=c(0, 0), cex=0.6)

for (i in 0:(nrow(M_bw)-2)) {
  text(1.25 + (i * 1.5), -2, rownames(M_bw)[i+1], xpd=NA, cex=0.6, srt = 45,
       adj=c(1, 0))
}
i <- 7
text(1.25 + (i * 1.5), -2, "MKL", xpd=NA, cex=0.6, srt = 45, adj=c(1, 0))
