...
for (i in 0:(nrow(M_bw)-2)) { 
  text(1.25 + (i * 1.5), -10, rownames(M_bw)[i+1], xpd=NA, cex=0.6, srt = 45,
       adj=c(1, 0))
}
i <- 7
text(1.25 + (i * 1.5), -10, "cuBLAS", xpd=NA, cex=0.6, srt = 45, adj=c(1, 0))
