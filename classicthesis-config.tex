...
\newcommand{\firstBox}{\tikz[baseline=0.25em]{\filldraw[fill=firstColor,   draw=black] (0,0) rectangle (.3,.3);}}
\newcommand{\secondBox}{\tikz[baseline=0.25em]{\filldraw[fill=secondColor, draw=black] (0,0) rectangle (.3,.3);}}
\newcommand{\thirdBox}{\tikz[baseline=0.25em]{\filldraw[fill=thirdColor,   draw=black] (0,0) rectangle (.3,.3);}}
\newcommand{\fourthBox}{\tikz[baseline=0.25em]{\filldraw[fill=fourthColor, draw=black] (0,0) rectangle (.3,.3);}}
