...
\newcommand{\from}[1]{\marginpar{\fcolorbox{Maroon}{Maroon}{\color{white}#1}}}
...
\usepackage[backgroundcolor=rulesbgcolor,linecolor=ruleslncolor,innerleftmargin=0pt,innerbottommargin=0pt, innertopmargin=1pt]{mdframed}
...
\newcommand{\zip}{$zip$\xspace}
\newcommand{\reduce}{$reduce$\xspace}
\newcommand{\scan}{$scan$\xspace}
\newcommand{\zipReduce}{$zipReduce$\xspace}
\newcommand{\allpairs}{$allpairs$\xspace}
\newcommand{\mapOverlap}{$mapOverlap$\xspace}
\newcommand{\stencil}{$stencil$\xspace}
