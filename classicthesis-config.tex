...
\newcommand{\myTitle}{Improving Programmability and Performance Portability on Many-Core Processors\xspace}
%\newcommand{\mySubtitle}{\xspace}
%On Improving Programmability and Performance Portability on Modern Parallel Processors
\newcommand{\myDegree}{Dr. rer. nat.\xspace}
\newcommand{\myName}{Michel Steuwer\xspace}
\newcommand{\myDekan}{Prof. Dr. Martin Stein\xspace}
\newcommand{\myProf}{Prof. Dr. Sergei Gorlatch\xspace}
\newcommand{\myOtherProf}{Lecturer Dr. Christophe Dubach\xspace}
\newcommand{\myFaculty}{Institute for Computer Science\xspace}
...
\newcommand{\CUBLAS}{{\small CUBLAS}\xspace}
\newcommand{\clBLAS}{cl{\small BLAS}\xspace}
\newcommand{\FDTD}{{\small FDTD}\xspace}
\newcommand{\HIV}{{\small HIV}\xspace}
\newcommand{\MIC}{{\small MIC}\xspace}
\newcommand{\MPI}{{\small MPI}\xspace}
\newcommand{\MKL}{{\small MKL}\xspace}
\newcommand{\TBB}{{\small TBB}\xspace}
\newcommand{\SSE}{{\small SSE}\xspace}
\newcommand{\AVX}{{\small AVX}\xspace}
\newcommand{\MD}{{\small MD}\xspace}
\newcommand{\SkePU}{Ske{\small PU}\xspace}
\newcommand{\JPAI}{{\small JPAI}\xspace}
\newcommand{\StarPU}{Star{\small PU}\xspace}
\newcommand{\OmpSs}{Omp{\small S}s\xspace}
