...
\part[Introduction \& Background]{Introduction \& Background}
...
\part{A novel code generation approach offering Performance Portability}
...
\include{Chapters/ChapterA} % Appendix A
...
\cleardoublepage\include{FrontBackMatter/CV} % CV
