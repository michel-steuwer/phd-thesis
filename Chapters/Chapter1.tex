...
\subsection*{Addressing the programmability challenge}
  % - a novel programming model (\SkelCL) for simplified programming of multi-\GPU systems
  % - Implementation of \SkelCL

\subsection*{Addressing the performance portability challenge}
  % - novel code generator generating highly optimized, device-specific code from single high-level representation
  % - formally defined patterns and rules; proofs show soundness
