...
\begin{figure}[tb]
  ...
  \caption{Programming effort (Lines of Code) of four \OpenCL-based vs. two \SkelCL-based implementations.}
...
\begin{figure}[tb]
  ...
  \caption{Runtime of different matrix multiplication implementations on the NVIDIA system for different sizes of the matrices.}
...
\begin{table}[tb]
  ...
  \begin{tabular}{lrrrrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Runtime results for all implementations on the NVIDIA system.}
...
\begin{figure}[tb]
  ...
  \caption{Runtime of all compared implementations for a matrix multiplication on the AMD system using one \GPU.}
...
\begin{table}[b]
  ...
  \begin{tabular}{lrrrrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Runtime results for all implementations of matrix multiplication on the AMD system.}
