...
We used the following driver versions and versions of the \CUDA toolkit:
258.19 and \CUDA 3.2 for the Mandelbrot set computation and the medical imaging application,
304.54 and \CUDA 5.0 for the Matrix Multiplication application,
319.37 and \CUDA 5.5 for the image processing applications, and,
finally, 331.62 and \CUDA 6.0 for the linear algebra applications and the physics simulation.
