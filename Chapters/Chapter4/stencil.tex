...
3) \code{MapOverlap}-based implementation, and
4) the \code{Stencil}-based implementation, correspondingly.
We observe that on larger stencil shape sizes, the \code{MapOverlap} and \code{Stencil}-based versions outperform the na{\"i}ve OpenCL implementation by $65\%$ and $62\%$, respectively.
