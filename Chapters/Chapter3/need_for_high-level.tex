...
For such synchronizations, \OpenCL uses \emph{events}, associated with an operation (line~\ref{lst:lmosem:redistribution:operation}) for waiting for the operation to finish (line \autoref{lst:lmosem:redistribution:wait}).
