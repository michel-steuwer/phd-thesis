...
When executing a skeleton of type \code{skeleton<T(U)>}, an object of type \code{U} has to be provided to receive an object of type \code{T}.
...
\bigskip
\spacedlowsmallcaps{Additional Arguments:}
...
\bigskip
\spacedlowsmallcaps{Lambda captures:}
...
\todo{Short conclusion: additional args vs. lambda capture:
  capture: at lambda creation time vs. add args at call time ...
}
