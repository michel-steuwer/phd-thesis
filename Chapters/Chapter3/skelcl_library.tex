...
\begin{figure}[p]
  \centering
  \includegraphics[width=.8\textwidth]{SkelCLOverview}
  \caption{Overview of the \SkelCL implementation.
    In the first step, the custom \code{skelclc} compiler transforms the initial source code into a representation where kernels are represented as strings.
