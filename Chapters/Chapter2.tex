...
In this famous letter~\cite{Dijkstra68a} he argued that instead programs should have a more rigid structure organizing code in procedures and using higher level control structures like \code{if} and \code{while}.
