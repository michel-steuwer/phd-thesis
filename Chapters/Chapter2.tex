...
\section{Programming of Multi-Core CPUs and GPUs}
  % programming approaches for multi-core CPUs and GPUs (Threads, OpenMP, OpenACC, CUDA)
...
qualifiers for pointers reflecting the four address spaces and vector data types, like \code{float4}.
