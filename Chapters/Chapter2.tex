...
\subsection{Graphics Processing Units}
  % GPUs
\autoref{fig:gpu} shows an abstract representation of the structural design of the Nvidia Kepler architecture -- Nvidia latest \GPU architecture for the high-performance computing market.
