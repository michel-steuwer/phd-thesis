...
\begin{proof}[Proof of \autoref{eq:algo:part-red}; option 1] Choose $n=m$ $\Rightarrow$
  \begin{align*}
...
Afterwards, in line~\lineNum{3} the entire work-group performs an iterative reduction where in 7 steps (this equals $log_2(128)$ following rule~\ref{fig:algo:red}) the data is further divided into pairs of two elements (using $\splitN\ 2$) which are reduced sequentially by the work-items.
