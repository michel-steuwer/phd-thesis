...
\autoref{eq:reduce12} shows our second expression implementing parallel reduction:
\begin{align}
  &\hspace{-1.5em}vecSum = \reduce\ (+)\ 0\nonumber\\
  &\hspace{-2em}\quad\begin{aligned}
    &=\hspace{.2em}
...
\end{align}
%
This expression closely resembles the third implementation shown in \autoref{lst:reduce2}.
...
\end{align}
%
This expression closely resembles the fourth implementation presented in \autoref{lst:reduce3}.
